    ...
    @if ($variant === 'create')
        <div class="space-y-5">
            <section class="space-y-4">
                <div>
                    <p class="eyebrow text-xs font-semibold uppercase tracking-[0.35em]">Basic info</p>
                    <p class="text-muted mt-2 text-sm">Start with the essentials required to save the visit.</p>
                </div>
            ...
            <section class="space-y-4">
                <div>
                    <p class="eyebrow text-xs font-semibold uppercase tracking-[0.35em]">Evaluation</p>
                </div>
            ...
            <section class="space-y-4">
                <div>
                    <p class="eyebrow text-xs font-semibold uppercase tracking-[0.35em]">Visit record</p>
                </div>
            ...
            <section
                class="surface-subtle space-y-3 rounded-3xl p-4"
                x-data="{ latitude: @js(old('latitude', $restaurant->latitude)), longitude: @js(old('longitude', $restaurant->longitude)) }"
            >
                <div>
                    <p class="eyebrow text-xs font-semibold uppercase tracking-[0.35em]">Location</p>
                    <p class="text-body mt-2 text-sm">Optional coordinates are preserved with the form when available.</p>
                </div>

                <p class="text-body text-sm" x-show="latitude && longitude" x-text="`${Number(latitude).toFixed(5)}, ${Number(longitude).toFixed(5)}`"></p>
            ...
            <section class="surface-subtle space-y-4 rounded-3xl p-4">
                <div>
                    <p class="eyebrow text-xs font-semibold uppercase tracking-[0.35em]">Optional extras</p>
                    <p class="text-body mt-2 text-sm">Add supporting details only if they help you remember the visit later.</p>
                </div>
    ...
    @else
        <div class="grid gap-5 sm:grid-cols-2">
            ...
            >
                ...
                <p class="text-body text-sm" x-show="latitude && longitude" x-text="`${Number(latitude).toFixed(7)}, ${Number(longitude).toFixed(7)}`"></p>
